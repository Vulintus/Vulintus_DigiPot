...
class Vulintus_MCP4xxx_DigPot {
	...
	public:
		...
		// Constructor. // 
		Vulintus_MCP4xxx_DigPot(uint8_t pin_cs);                        // Default SPI with chip select.
        Vulintus_MCP4xxx_DigPot(SPIClass *spi_bus, uint8_t pin_cs);     // Specified SPI with chip select.
